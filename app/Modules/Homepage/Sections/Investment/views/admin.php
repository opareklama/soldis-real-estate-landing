...
esc_html_e( 'Kodėl investuojame? Section', 'soldis-landing' ); ?></h2>
	
	<table class="form-table">
		<tr>
			<th scope="row"><label for="soldis_inv_enable"><?php defined( 'ABSPATH' ) || exit;

esc_html_e( 'Enable Section', 'soldis-landing' ); ?></label></th>
			<td>
				<input type="checkbox" id="soldis_inv_enable" name="soldis_investment_settings[enable_investment]" value="1" <?php defined( 'ABSPATH' ) || exit;

checked( '1', $options['enable_investment'] ); ?> />
			</td>
		</tr>
		
		<tr>
			<th scope="row"><label for="soldis_inv_eyebrow"><?php defined( 'ABSPATH' ) || exit;

esc_html_e( 'Eyebrow Text', 'soldis-landing' ); ?></label></th>
			<td>
				<input type="text" id="soldis_inv_eyebrow" name="soldis_investment_settings[eyebrow]" value="<?php defined( 'ABSPATH' ) || exit;
...
echo esc_attr( $options['eyebrow'] ); ?>" class="regular-text" />
		...
		<tr>
			<th scope="row"><label for="soldis_inv_heading"><?php defined( 'ABSPATH' ) || exit;

esc_html_e( 'Heading', 'soldis-landing' ); ?></label></th>
			<td>
				<input type="text" id="soldis_inv_heading" name="soldis_investment_settings[heading]" value="<?php defined( 'ABSPATH' ) || exit;
...
echo esc_attr( $options['heading'] ); ?>" class="regular-text" />
		...
		<tr>
			<th scope="row"><label for="soldis_inv_desc"><?php defined( 'ABSPATH' ) || exit;

esc_html_e( 'Description', 'soldis-landing' ); ?></label></th>
			<td>
				<textarea id="soldis_inv_desc" name="soldis_investment_settings[description]" rows="5" class="large-text"><?php defined( 'ABSPATH' ) || exit;
...
esc_html_e( 'Desktop Padding (px)', 'soldis-landing' ); ?></label></th>
			<td>
				<input type="number" name="soldis_investment_settings[pad_top_d]" value="<?php defined( 'ABSPATH' ) || exit;

echo esc_attr( $options['pad_top_d'] ); ?>" class="small-text" placeholder="Top">
				<input type="number" name="soldis_investment_settings[pad_bot_d]" value="<?php defined( 'ABSPATH' ) || exit;
...
esc_html_e( 'Tablet Padding (px)', 'soldis-landing' ); ?></label></th>
			<td>
				<input type="number" name="soldis_investment_settings[pad_top_t]" value="<?php defined( 'ABSPATH' ) || exit;

echo esc_attr( $options['pad_top_t'] ); ?>" class="small-text" placeholder="Top">
				<input type="number" name="soldis_investment_settings[pad_bot_t]" value="<?php defined( 'ABSPATH' ) || exit;
...
esc_html_e( 'Mobile Padding (px)', 'soldis-landing' ); ?></label></th>
			<td>
				<input type="number" name="soldis_investment_settings[pad_top_m]" value="<?php defined( 'ABSPATH' ) || exit;

echo esc_attr( $options['pad_top_m'] ); ?>" class="small-text" placeholder="Top">
				<input type="number" name="soldis_investment_settings[pad_bot_m]" value="<?php defined( 'ABSPATH' ) || exit;
...
esc_html_e( 'Content Blocks', 'soldis-landing' ); ?></h3>
...
esc_html_e( 'Block', 'soldis-landing' ); ?> <span class="index"><?php defined( 'ABSPATH' ) || exit;
...
echo $index + 1; ?></span></h4>
					...
					<div class="soldis-repeater-content">
						<div class="soldis-form-row">
							<label>
								<input type="checkbox" name="soldis_investment_settings[blocks][<?php defined( 'ABSPATH' ) || exit;

echo $index; ?>][enabled]" value="1" <?php defined( 'ABSPATH' ) || exit;

checked( '1', $block['enabled'] ?? '0' ); ?>>
								<?php defined( 'ABSPATH' ) || exit;

esc_html_e( 'Enable Block', 'soldis-landing' ); ?>
							</label>
						</div>
						<div class="soldis-form-row">
...
esc_html_e( 'Title', 'soldis-landing' ); ?></label>
							<input type="text" name="soldis_investment_settings[blocks][<?php defined( 'ABSPATH' ) || exit;

echo $index; ?>][title]" value="<?php defined( 'ABSPATH' ) || exit;

echo esc_attr( $block['title'] ?? '' ); ?>" class="regular-text">
						</div>
						<div class="soldis-form-row">
							<label><?php defined( 'ABSPATH' ) || exit;

esc_html_e( 'Description', 'soldis-landing' ); ?></label>
							<textarea name="soldis_investment_settings[blocks][<?php defined( 'ABSPATH' ) || exit;

echo $index; ?>][desc]" rows="3" class="large-text"><?php defined( 'ABSPATH' ) || exit;

echo esc_textarea( $block['desc'] ?? '' ); ?></textarea>
						</div>
						<div class="soldis-form-row">
							<label><?php defined( 'ABSPATH' ) || exit;
...
echo esc_attr( $block['icon'] ?? 'sparkles' ); ?>" class="regular-text">
...
esc_html_e( '+ Add Block', 'soldis-landing' ); ?>
	</button>
...
esc_html_e( 'Bottom Closing Banner', 'soldis-landing' ); ?></h3>
	<table class="form-table">
		<tr>
			<th scope="row"><label for="soldis_inv_callout_enable"><?php defined( 'ABSPATH' ) || exit;

esc_html_e( 'Enable Callout', 'soldis-landing' ); ?></label></th>
			<td>
				<input type="checkbox" id="soldis_inv_callout_enable" name="soldis_investment_settings[callout_enable]" value="1" <?php defined( 'ABSPATH' ) || exit;

checked( '1', $options['callout_enable'] ); ?> />
			</td>
		</tr>
		<tr>
			<th scope="row"><label for="soldis_inv_callout_title"><?php defined( 'ABSPATH' ) || exit;

esc_html_e( 'Title', 'soldis-landing' ); ?></label></th>
			<td>
				<input type="text" id="soldis_inv_callout_title" name="soldis_investment_settings[callout_title]" value="<?php defined( 'ABSPATH' ) || exit;

echo esc_attr( $options['callout_title'] ); ?>" class="regular-text" />
			</td>
		</tr>
		<tr>
			<th scope="row"><label for="soldis_inv_callout_desc"><?php defined( 'ABSPATH' ) || exit;

esc_html_e( 'Description', 'soldis-landing' ); ?></label></th>
			<td>
				<textarea id="soldis_inv_callout_desc" name="soldis_investment_settings[callout_desc]" rows="3" class="large-text"><?php defined( 'ABSPATH' ) || exit;
