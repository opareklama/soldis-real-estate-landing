...
esc_html_e( 'FAQ (DUK) Section', 'soldis-landing' ); ?></h2>
	
	<table class="form-table">
		<tr>
			<th scope="row"><label for="soldis_faq_enable"><?php defined( 'ABSPATH' ) || exit;

esc_html_e( 'Enable Section', 'soldis-landing' ); ?></label></th>
			<td>
				<input type="checkbox" id="soldis_faq_enable" name="soldis_faq_settings[enable_faq]" value="1" <?php defined( 'ABSPATH' ) || exit;

checked( '1', $options['enable_faq'] ); ?> />
			</td>
		</tr>
		
		<tr>
			<th scope="row"><label for="soldis_faq_eyebrow"><?php defined( 'ABSPATH' ) || exit;

esc_html_e( 'Eyebrow Text', 'soldis-landing' ); ?></label></th>
			<td>
				<input type="text" id="soldis_faq_eyebrow" name="soldis_faq_settings[eyebrow]" value="<?php defined( 'ABSPATH' ) || exit;
...
echo esc_attr( $options['eyebrow'] ); ?>" class="regular-text" />
		...
		<tr>
			<th scope="row"><label for="soldis_faq_heading"><?php defined( 'ABSPATH' ) || exit;

esc_html_e( 'Heading', 'soldis-landing' ); ?></label></th>
			<td>
				<input type="text" id="soldis_faq_heading" name="soldis_faq_settings[heading]" value="<?php defined( 'ABSPATH' ) || exit;
...
echo esc_attr( $options['heading'] ); ?>" class="regular-text" />
		...
		<tr>
			<th scope="row"><label for="soldis_faq_desc"><?php defined( 'ABSPATH' ) || exit;

esc_html_e( 'Description', 'soldis-landing' ); ?></label></th>
			<td>
				<textarea id="soldis_faq_desc" name="soldis_faq_settings[description]" rows="5" class="large-text"><?php defined( 'ABSPATH' ) || exit;
...
esc_html_e( 'Desktop Padding (px)', 'soldis-landing' ); ?></label></th>
			<td>
				<input type="number" name="soldis_faq_settings[pad_top_d]" value="<?php defined( 'ABSPATH' ) || exit;

echo esc_attr( $options['pad_top_d'] ); ?>" class="small-text" placeholder="Top">
				<input type="number" name="soldis_faq_settings[pad_bot_d]" value="<?php defined( 'ABSPATH' ) || exit;
...
esc_html_e( 'Tablet Padding (px)', 'soldis-landing' ); ?></label></th>
			<td>
				<input type="number" name="soldis_faq_settings[pad_top_t]" value="<?php defined( 'ABSPATH' ) || exit;

echo esc_attr( $options['pad_top_t'] ); ?>" class="small-text" placeholder="Top">
				<input type="number" name="soldis_faq_settings[pad_bot_t]" value="<?php defined( 'ABSPATH' ) || exit;
...
esc_html_e( 'Mobile Padding (px)', 'soldis-landing' ); ?></label></th>
			<td>
				<input type="number" name="soldis_faq_settings[pad_top_m]" value="<?php defined( 'ABSPATH' ) || exit;

echo esc_attr( $options['pad_top_m'] ); ?>" class="small-text" placeholder="Top">
				<input type="number" name="soldis_faq_settings[pad_bot_m]" value="<?php defined( 'ABSPATH' ) || exit;
...
esc_html_e( 'FAQ Items', 'soldis-landing' ); ?></h3>
...
esc_html_e( 'Question', 'soldis-landing' ); ?> <span class="index"><?php defined( 'ABSPATH' ) || exit;
...
echo $index + 1; ?></span></h4>
					...
					<div class="soldis-repeater-content">
						<div class="soldis-form-row">
							<label>
								<input type="checkbox" name="soldis_faq_settings[items][<?php defined( 'ABSPATH' ) || exit;

echo $index; ?>][enabled]" value="1" <?php defined( 'ABSPATH' ) || exit;

checked( '1', $item['enabled'] ?? '0' ); ?>>
								<?php defined( 'ABSPATH' ) || exit;

esc_html_e( 'Enable Item', 'soldis-landing' ); ?>
							</label>
							<label style="margin-left:20px;">
								<input type="checkbox" name="soldis_faq_settings[items][<?php defined( 'ABSPATH' ) || exit;

echo $index; ?>][open]" value="1" <?php defined( 'ABSPATH' ) || exit;

checked( '1', $item['open'] ?? '0' ); ?>>
								<?php defined( 'ABSPATH' ) || exit;

esc_html_e( 'Default Open (on load)', 'soldis-landing' ); ?>
							</label>
						</div>
						<div class="soldis-form-row">
							<label><?php defined( 'ABSPATH' ) || exit;

esc_html_e( 'Question', 'soldis-landing' ); ?></label>
							<input type="text" name="soldis_faq_settings[items][<?php defined( 'ABSPATH' ) || exit;

echo $index; ?>][question]" value="<?php defined( 'ABSPATH' ) || exit;

echo esc_attr( $item['question'] ?? '' ); ?>" class="regular-text">
						</div>
						<div class="soldis-form-row">
							<label><?php defined( 'ABSPATH' ) || exit;

esc_html_e( 'Answer', 'soldis-landing' ); ?></label>
							<textarea name="soldis_faq_settings[items][<?php defined( 'ABSPATH' ) || exit;

echo $index; ?>][answer]" rows="4" class="large-text"><?php defined( 'ABSPATH' ) || exit;

echo esc_textarea( $item['answer'] ?? '' ); ?></textarea>
						</div>
					</div>
				</div>
			<?php defined( 'ABSPATH' ) || exit;
...
esc_html_e( '+ Add Question', 'soldis-landing' ); ?>
	</button>
